...
<div class="content-box"> 
	<div class="box-header clear"> 
		<ul class="tabs clear"> 
			...
			<li><a href="#form"><i class="fa fa-plus" title="thêm"></i> Thêm đơn hàng</a></li>
		</ul> 
	...
	<div class="box-body clear"> 
		<!-- TABLE --> 
		<div id="data-table"> 
			<h1 style="text-align: center">Danh sách đơn nhập hàng</h1>
			...
			<form method="post" action=""> 
				...
				<thead> 
					<tr> 
						...
						<th></th>
				<tbody> 
					@foreach($donnhaphang as $hd)
					<tr> 
						<td>{{$hd->MaDNH}}</td> 
						<td>{{$hd->nhaCungCap->TenNCC}}</td> 
						<td>{{$hd->NgayNhap}}</td>
						...
						<td >
							...
							<a href="donnhaphang-chitiet-{{$hd->MaDNH}}"><i class="fa fa-eye" title="chi tiết" ></i></a>
						</td> 
					</tr> 
	                @endforeach                      
			...
			<div class="left">
				...
				<form method="post" action="" style="width: 100%"> 
					...
					<div class="form-field fl " style="margin-top: 40px"> 
							...
							<input type="number" id="sl" class="text fl" name="SoLuong" value="1" /> 
					</div><!-- /.form-field -->
			...
			<div class="right">
				<form action=" " method="post" class="form" enctype="multipart/form-data">
					...
					<div class="form-field" style="width: 100%"> 
						<label for="textfield" class="form-label fl-space2" style="width: 23%">Tên nhà cung cấp:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="TenNCC" value="" style="width: 73%" /> 
					</div><!-- /.form-field -->  
					...
					<div class="form-field" style="float: right;text-align: right"> 
						<label for="textfield" class="form-label fl-space2" style="width: 80px">Tổng tiền: <span class="required">*</span></label> 
						<input type="text" id="tt" class="text" name="TongTien" value="0"  style="text-align: right;" /> 
					</div><!-- /.form-field --> 
					<div class="clear"></div>
					<div class="form-field" style="float: right;text-align: right;"> 
						<label for="textfield" class="form-label fl-space2" style="width: 80px">Trả trước: <span class="required">*</span></label> 
						<input type="text" id="textfield" class="text" value="0" name="DaTra" style="text-align: right;"  /> 
					</div><!-- /.form-field --> 
					<div class="clear"></div>
