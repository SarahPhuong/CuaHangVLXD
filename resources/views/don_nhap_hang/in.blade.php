...
<body onload="window.print();">
  ...
  <br/>
  <div class="khachhang">
      Tên nhà cung cấp: <b>{{$donnhaphang->nhaCungCap->TenNCC}}</b><br>
      <span style="margin-right: 280px">Địa chỉ:<b> {{$donnhaphang->nhaCungCap->DiaChi}}</b></span>
      Số điện thoại: <b>{{$donnhaphang->nhaCungCap->SoDienThoai}}</b>
  </div>
  <br>
  <table class="TableData">
    ...
    <tr>
      ...
      <td class="cotSo">{{number_format(($donnhaphang->TongTien),3,",",".")}} vnđ</td>
    </tr>
    <tr>
      <td colspan="4" class="tong">Trả trước</td>
      <td class="cotSo">{{number_format(($donnhaphang->DaTra),3,",",".")}} vnđ</td>
    </tr>
    <tr>
      <td colspan="4" class="tong">Còn nợ</td>
      <td class="cotSo">{{number_format(($donnhaphang->ConLai),3,",",".")}} vnđ</td>
    </tr>
    </table>
  <div class="footer-left"> <br/>
    Đại diện nhà cung cấp <br>(Ký, ghi rõ họ tên)</div> 
