...
<div class="content-box"> 
	<div class="box-header clear"> 
		<h2>Thêm đơn hàng cho khách hàng {{$khachhang->MaKH}}</h2> 
	</div>
			...
			<div class="right">
				<form action=" " method="post" class="form" enctype="multipart/form-data">
					...
					<div class="form-field" style="width: 100%"> 
						...
						<input type="text" id="textfield" class="text fl" name="TenKH" value="{{$khachhang->TenKH}}" style="width: 75%"  disabled="" /> 
					</div><!-- /.form-field -->  
					<div class="clear"></div>
					<div class="form-field "> 
						<label for="textfield" class="form-label fl-space2" style="width: 34%">Số điện thoại:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="SoDienThoai" value="{{$khachhang->SoDienThoai}}"  style="width: 50%" disabled="" /> 
					</div><!-- /.form-field --> 
					
					<div class="form-field "> 
						<label for="textfield" class="form-label fl-space2" style="width: 17%">Email:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="Email" value="{{$khachhang->Email}}" style="width: 74%"  disabled="" /> 
					</div><!-- /.form-field -->
					<div class="clear"></div>
					<div class="form-field" style="width: 100%"> 
						<label for="textfield" class="form-label fl-space2" style="width: 10%"> Địa chỉ:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="DiaChi" value="{{$khachhang->DiaChi}}" style="width: 86%; height: 30px" disabled="" /> 
					</div><!-- /.form-field --> 
					...
					<div class="form-field" style="float: right;"> 
						...
						<input type="text" id="textfield" class="text fl" name="DaTra" value="0"   style="text-align: right;"/> 
					</div><!-- /.form-field --> 
					<div class="clear"></div>
					<div class="form-field" style="float: right;"> 
