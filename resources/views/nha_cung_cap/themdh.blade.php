...
<div class="content-box"> 
	<div class="box-header clear"> 
		<h2>Thêm đơn hàng cho nhà cung cấp {{$ncc->MaNCC}}</h2> 
	</div>
			...
			<div class="right">
				<form action=" " method="post" class="form" enctype="multipart/form-data">
					...
					<div class="form-field" style="width: 100%"> 
						<label for="textfield" class="form-label fl-space2" style="width: 21%">Tên NCC:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="TenNCC" value="{{$ncc->TenNCC}}" style="width: 75%"  disabled="" /> 
					</div><!-- /.form-field -->  
					<div class="clear"></div>
					<div class="form-field "> 
						<label for="textfield" class="form-label fl-space2" style="width: 34%">Số điện thoại:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="SoDienThoai" value="{{$ncc->SoDienThoai}}"  style="width: 50%" disabled="" /> 
					</div><!-- /.form-field --> 
					
					<div class="form-field "> 
						<label for="textfield" class="form-label fl-space2" style="width: 17%">Email:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="Email" value="{{$ncc->Email}}" style="width: 74%"  disabled="" /> 
					</div><!-- /.form-field -->
					<div class="clear"></div>
					<div class="form-field" style="width: 100%"> 
						<label for="textfield" class="form-label fl-space2" style="width: 10%"> Địa chỉ:  <span class="required" >*</span></label> 
						<input type="text" id="textfield" class="text fl" name="DiaChi" value="{{$ncc->DiaChi}}" style="width: 86%; height: 30px" disabled="" /> 
					</div><!-- /.form-field --> 
